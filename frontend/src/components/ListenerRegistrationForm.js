...
const ListenerRegistrationForm = () => {
    ...
    return (
        <div className={styles.form}>
            <label>Username: <input type="text" placeholder="Username" onChange={handleUsernameChange}></input></label>
            <label>Password: <input type="text" placeholder="Username" onChange={handlePasswordChange}></input></label>
