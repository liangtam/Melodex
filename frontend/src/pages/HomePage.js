                ...
                <div className={styles.centered}>
                    ...
                    <div className={styles.searchArea}>
                        ...
                        <div className={styles.filters}>
                            ...
                            <label>:</label><input type="text" onChange={handleVal1Change}></input>
                            {artistSelected && 
                            ...
                            <label>is at least: </label><input type="text" placeholder="An integer" onChange={handleVal2Change}></input>
